...
\subsection{Scope}
Il prodotto da realizzare è un client Twitter in grado di fornire analisi e funzionalità specifiche per determinate tematiche.\\
In particolare sono state chieste le seguenti funzioni:
\begin{itemize}
