...
\begin{tikzpicture}[auto, thick,
    ...
    \node[pipestep, below=of gitlab]                    (jenkins) {\includegraphics[width=1cm]{./img/icons/jenkins.png}\\Avvio pipeline\\Jenkins};
    ...
    \node[pipestep, below=of padding, yshift=-0.5cm]    (sonarqube) {\includegraphics[width=1cm]{./img/icons/sonarqube.png}\\Sonarqube};
