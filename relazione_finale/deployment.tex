...
Il deploy avviene su container Docker allineati al codice del branch di riferimento (\cite{deploy_prod} \cite{deploy_dev}). Il database risiede su un container separato.